...
const apiResponseHandler = {
  ...
  updateAPIResponseHandler: async (data: z.infer<typeof formSchema>, ReduxCall: any, updateAPITrigger: any, form: any, navigate: NavigateFunction, userAccountRetrieveAPITrigger: any) => {
    try {
