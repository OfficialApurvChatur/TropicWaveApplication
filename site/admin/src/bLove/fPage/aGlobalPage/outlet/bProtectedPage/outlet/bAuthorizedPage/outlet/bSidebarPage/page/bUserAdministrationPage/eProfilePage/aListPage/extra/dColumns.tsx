      ...
      return (
        <div className="flex space-x-2">
          <span className="max-w-[450px] truncate font-normal hover:underline">
            <Link to={`${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.bUserAdministrationRoute.eProfileRoute.cRetrieveRoute}/${row.getValue("_id")}`} >
              {row.getValue("aTitle")}
            </Link>
          </span>
        </div>
    ...
    cell: ({ row }) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-[160px]">
          ...
          <DropdownMenuItem asChild>
            <Link to={`${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.bUserAdministrationRoute.eProfileRoute.dUpdateRoute}/${row.getValue("_id")}`} >
              Update
            </Link>
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem asChild>
            <Link to={`${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.bUserAdministrationRoute.eProfileRoute.eDeleteRoute}/${row.getValue("_id")}`} >
              Delete
            </Link>
          </DropdownMenuItem>
        </DropdownMenuContent>
