...
const submitHandler = (data: z.infer<typeof formSchema>, form: any, ReduxCall: any, APICall: any, navigate: NavigateFunction) => {
  apiResponseHandler.submitAPIResponseHandler(data, ReduxCall, APICall.submitAPITrigger, form, navigate, APICall.roleListAPIResponse, APICall.userAccountRetrieveAPITrigger)
}
