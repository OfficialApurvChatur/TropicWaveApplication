...
const apiResponseHandler = {
  submitAPIResponseHandler: async (data: z.infer<typeof formSchema>, ReduxCall: any, submitAPITrigger: any, form: any, navigate: NavigateFunction, userAccountRetrieveAPITrigger: any) => {
    try {
